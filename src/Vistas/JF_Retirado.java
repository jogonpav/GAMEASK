 ...
 * @author josep
 */
public class JF_Retirado extends javax.swing.JFrame {
    ...
    public JF_Retirado() {
        ...
        jLabel2.setText("Puntos Obtenidos: " + String.valueOf(his.getPremio()));
    ...
    private void initComponents() {
        ...
        jLabel3.setText("NO LLEGASTE A TU DESTINO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JF_Retirado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JF_Retirado().setVisible(true);
            }
        });
    }
    ...
    class BackgroundPanel extends JPanel{ //inner class
        ...
        public void paint (Graphics g){
            ...
            imagen = new ImageIcon(getClass().getResource("/Imagenes/2262.jpg")).getImage();
